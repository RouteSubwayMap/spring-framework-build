...
We're going to provide validation behavior for the `cn.eleven.Person` class by implementing the
...
----
	public class PersonValidator implements Validator {
		...
		/**
		 * This Validator validates *just* cn.eleven.Person instances
		 */
		public boolean supports(Class clazz) {
			return cn.eleven.Person.class.equals(clazz);
		}

		public void validate(Object obj, Errors e) {
			ValidationUtils.rejectIfEmpty(e, "name", "name.empty");
			cn.eleven.Person p = (cn.eleven.Person) obj;
			if (p.getAge() < 0) {
