...
cannot be fully determined from static analysis and a cn.eleven.test will be placed in the code to
...
choice (a good cn.eleven.test is whether you consider the pointcut expression to be a part of your
...
object under cn.eleven.test and proceed as normal. If `@Configurable` types __have__ been woven by
AspectJ then you can still unit cn.eleven.test outside of the container as normal, but you will
