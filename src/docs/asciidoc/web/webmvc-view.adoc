...
----
	...
	public class SampleController {
		...
		@GetMapping("/sample")
		public String cn.eleven.test(Model model) {
...
https://github.com/spring-projects/spring-framework/tree/master/spring-webmvc/src/cn.eleven.test/java/org/springframework/web/servlet/view/script[java], and
https://github.com/spring-projects/spring-framework/tree/master/spring-webmvc/src/cn.eleven.test/resources/org/springframework/web/servlet/view/script[resources],
...
----
	...
	public class HomePage extends AbstractExcelView {
		...
		protected void buildExcelDocument(Map model, HSSFWorkbook wb, HttpServletRequest req,
			...
			setText(cell, "Spring-Excel cn.eleven.test");
...
----
	...
	public class HomePage extends AbstractJExcelView {
		...
		protected void buildExcelDocument(Map model, WritableWorkbook wb,
			...
			sheet.addCell(new Label(0, 0, "Spring-Excel cn.eleven.test"));
