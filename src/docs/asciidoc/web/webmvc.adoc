...
----
	...
	class PersonController {
		...
		@GetMapping("/{id}")
		public cn.eleven.Person getPerson(@PathVariable Long id) {
			// ...
		}

		@PostMapping
		@ResponseStatus(HttpStatus.CREATED)
		public void add(@RequestBody cn.eleven.Person person) {
			// ...
		}
	}
----
...
You can narrow request mappings based on request parameter conditions. You can cn.eleven.test for the
...
* {doc-spring-security}/html5/#cn.eleven.test-mockmvc[Spring MVC Test Support]
