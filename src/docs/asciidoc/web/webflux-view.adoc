...
https://github.com/spring-projects/spring-framework/tree/master/spring-webflux/src/cn.eleven.test/java/org/springframework/web/reactive/result/view/script[java], and
https://github.com/spring-projects/spring-framework/tree/master/spring-webflux/src/cn.eleven.test/resources/org/springframework/web/reactive/result/view/script[resources],
